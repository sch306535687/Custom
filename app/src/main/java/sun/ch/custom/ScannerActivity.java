...
public class ScannerActivity extends Activity {
    private int[] ImagesArray = new int[]{R.mipmap.a, R.mipmap.b, R.mipmap.c, R.mipmap.d, R.mipmap.e};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化圆点
        pointContain = (LinearLayout) findViewById(R.id.pointContain);
        for (int i = 0; i < ImagesArray.length; i++) {
            ImageView point = new ImageView(ScannerActivity.this);
    ...
    private class MyViewPager extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            position %= ImagesArray.length;
            ImageView imageView = new ImageView(ScannerActivity.this);
